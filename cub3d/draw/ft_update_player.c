...
/*   Updated: 2020/10/15 20:54:07 by ynoam            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_update_player(void)
{
	...
	{
		x = g_player.x + (ft_cos(g_player.direction + 90) * g_player.mov_speed * g_player.lateral);
		y = g_player.y + (ft_sin(g_player.direction + 90) * g_player.mov_speed * g_player.lateral);
	}
	if (g_player.lateral == -1)
	{
